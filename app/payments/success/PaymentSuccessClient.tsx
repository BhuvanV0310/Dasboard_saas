  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#eaf1fb] to-white flex items-center justify-center">
      <div className="text-center max-w-2xl mx-auto p-8">
        ...
        {/* Success Message */}
        <h1 className="text-4xl font-bold text-[#0047ab] mb-4">Payment Successful!</h1>
        <p className="text-xl text-gray-600 mb-8">Thank you for subscribing. Your account has been upgraded and you now have access to all premium features.</p>
