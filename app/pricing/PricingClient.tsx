    ...
    <div className="min-h-screen bg-gradient-to-br from-[#eaf1fb] to-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-[#0047ab] mb-4">Choose Your Plan</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">Select the perfect plan for your business needs. All plans include our powerful sentiment analysis tools.</p>
        </div>
          ...
          {plans
            ...
            .map((plan, index) => (
              ...
              >
                ...
                <div className="p-8">
                  {/* Plan Name */}
                  <h3 className="text-2xl font-bold text-[#0047ab] mb-2">{plan.name}</h3>
                  ...
                  {/* Price */}
                  <div className="mb-6">
                    <span className="text-5xl font-bold text-[#0047ab]">${plan.price}</span>
